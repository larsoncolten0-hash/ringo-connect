...
export const translations = {
  en: {
    ...
    getStarted: {
      ...
      totalAddon: "Extra",
      totalDue: "Total",
      totalNote: "You don't pay anything now — this is just so you know what to expect.",
    },
    installPrompt: {
  ...
  fr: {
    ...
    getStarted: {
      ...
      totalDue: "Total",
      totalNote: "Vous ne payez rien maintenant — c'est juste pour que vous sachiez à quoi vous attendre.",
    },
    installPrompt: {
